        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-right pull-left"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="{{route('showCategories')}}"><i class="fa fa-circle-o"></i>دسته ها</a></li>
                    <li><a href="{{route('createCategoryForm')}}"><i class="fa fa-circle-o"></i>ایجاد دسته</a></li>
                    {{--                        <li><a href="{{route('updateCategory')}}"><i class="fa fa-circle-o"></i>ویرایش دسته</a></li>--}}
                    {{--                        <li><a href="{{route('deleteCategory')}}"><i class="fa fa-circle-o"></i>حذف دسته</a>--}}
                    {{--            </li>--}}
                </ul>
            {{--        </li>--}}
            <li class="treeview">
              ...
              <i class="fa fa-angle-right pull-left"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="#"><i class="fa fa-circle-o">ویژگی ها</i></a></li>
                    <li><a href="{{route('createAttributeForm')}}"><i class="fa fa-circle-o"></i>ایجاد ویژگی</a></li>
